...
##    def __init__(self, options, parent=None):
    def __init__(self, parent=None):        
        ...
        Label(self, text="Merge Several Run Numbers").pack()

        self.fields = 'DataSet','Run Numbers'
    ...
    def fetch(self,entries):
        try:
            ...
            cmd = './MergeJobForSimilarConditions.py ' + inp[0] + ' '+ inp[1]  
            ch = "echo $HOME"
...
#            cmd = 'bsub -q cmscaf -e ' + job_cerr  + ' -o ' + job_cout + '-J ' + ' MergeJobForAGivenRunNumber.py ' + inp[0] + ' ' + inp[1] + ' ' + inp[2]
    ...
    def makeform(self,root, fields):
        entries = []
        i = 0
        default = ['Insert Dataset name','Insert Run Numbers separated by points i.e. 66111.66112']
