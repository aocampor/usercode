...
##        print
    ...
    def fetch(self,entries):
        try:
            ...
            cmd = './RunJobForAGivenRunNumberNew.py ' + str(inp[0]) + ' ' + str(inp[1]) + ' ' + str(inp[2]) + ' ' + str(inp[3]) + ' ' + str(inp[4]) + ' '+str(self.var1.get())+ ' '+str(self.var2.get())+ ' '+str(self.var3.get())+ ' '+str(self.var4.get())+ ' '+str(self.var5.get()) + ' '+str(self.var6.get()) + ' '  + str(self.var7.get())+ ' '  + str(self.var6.get())+ ' '  + str(self.var6.get())+ ' '  + str(self.var6.get())+ ' '  + str(self.var6.get())+ ' '  + str(self.var6.get())+ ' '  + str(self.var6.get())+ ' '  + str(self.var6.get())+ ' '  + str(self.var6.get())+ ' '  + str(self.var6.get())+ ' '  + str(self.var6.get())
            os.system(cmd)
            return 1
        except ValueError:
...
#       default = ['CMSSW_2_1_10','/Cosmics/Commissioning08_CRAFT_ALL_V4_ReReco-v1/RECO','70195','1','0']
        default = ['CMSSW_3_1_0','/StreamExpress/Commissioning09-RpcCalHLT-v5/ALCARECO','102207','-1','0']
        for field in fields:
