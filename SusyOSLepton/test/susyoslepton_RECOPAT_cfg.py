...
inputfile = 'file:/lustre/cms/store/user/aocampor/SUSY/LM0/PAT/LM0_SUSY_PAT_10.root'
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('PAT_par.root') )
