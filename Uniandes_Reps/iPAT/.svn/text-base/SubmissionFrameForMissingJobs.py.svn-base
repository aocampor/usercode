...
##        print
    ...
    def fetch(self,entries):
        try:
            ...
            cmd = './filecounter.py ' + inp[0] + ' ' + inp[1] + ' ' + inp[2] + ' ' + str(self.var1.get())+ ' '+str(self.var2.get())+ ' '+str(self.var3.get())+ ' '+str(self.var4.get())+ ' '+str(self.var5.get()) + ' '+str(self.var6.get()) + ' ' +str(self.var7.get()) + ' '  + str(self.var8.get())+ ' '+str(self.var9.get())+ ' '+str(self.var10.get())+ ' '+str(self.var11.get())+ ' '+str(self.var12.get()) + ' '+str(self.var13.get()) + ' ' +str(self.var14.get()) +' ' +str(self.var15.get()) + ' '+str(self.var16.get()) + ' ' +str(self.var17.get()) +'&'
...
#       default = ['CMSSW_2_1_10','/Cosmics/Commissioning09-PromptReco-v1/RECO ','79045']
        default = ['CMSSW_3_2_8','/Cosmics/Commissioning09-PromptReco-v9/RECO ','118367']
        for field in fields:
