...
#---------------------------------------- Noise ---------------------------------------------------
        ...
        TH1F.Noise_W2_Far = gDirectory.FindObjectAny("W+2_Far_Side")
        TH1F.Noise_W2_Near = gDirectory.FindObjectAny("W+2_Near_Side")
        TH1F.Noise_W1_Far = gDirectory.FindObjectAny("W+1_Far_Side")
        TH1F.Noise_W1_Near = gDirectory.FindObjectAny("W+1_Near_Side")
        TH1F.Noise_W0_Far = gDirectory.FindObjectAny("W+0_Far_Side")
        TH1F.Noise_W0_Near = gDirectory.FindObjectAny("W+0_Near_Side")
        TH1F.Noise_Wm1_Far = gDirectory.FindObjectAny("W-1_Far_Side")
        TH1F.Noise_Wm1_Near = gDirectory.FindObjectAny("W-1_Near_Side")
        TH1F.Noise_Wm2_Far = gDirectory.FindObjectAny("W-2_Far_Side")
        TH1F.Noise_Wm2_Near = gDirectory.FindObjectAny("W-2_Near_Side")
...
##-------------------------- W-2 Noise -------------------------------------------------
##_near_
        if(TH1F.Noise_Wm2_Near):
            c_wheel_m2_near_n = TCanvas("c_wheel_m2_near_n", "Wheel -2 near noise",23,91,1247,400)
            c_wheel_m2_near_n.SetHighLightColor(2)
            c_wheel_m2_near_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_m2_near_n.SetFillColor(0)
            c_wheel_m2_near_n.SetBorderMode(0)
            c_wheel_m2_near_n.SetBorderSize(2)
            c_wheel_m2_near_n.SetLeftMargin(0.084172)
            c_wheel_m2_near_n.SetRightMargin(0.05489479)
            c_wheel_m2_near_n.SetBottomMargin(0.3698297)
            c_wheel_m2_near_n.SetFrameBorderMode(0)
            c_wheel_m2_near_n.SetFrameBorderMode(0)
            c_wheel_m2_near_n.SetLogy(1)
            
            TH1F.Noise_Wm2_Near.SetMaximum(100)
            TH1F.Noise_Wm2_Near.SetMinimum(0.001)
            TH1F.Noise_Wm2_Near.SetMarkerColor(1)
            TH1F.Noise_Wm2_Near.SetMarkerStyle(22)
            TH1F.Noise_Wm2_Near.GetXaxis().SetLabelFont(32)
            TH1F.Noise_Wm2_Near.GetXaxis().SetTitleFont(32)
            TH1F.Noise_Wm2_Near.GetYaxis().SetTitle("%")
            TH1F.Noise_Wm2_Near.GetYaxis().SetLabelFont(32)
            TH1F.Noise_Wm2_Near.GetYaxis().SetTitleFont(32)
            
            TH1F.Noise_Wm2_Near.Draw()
            
            
            c_wheel_m2_near_n.Update()
            c_wheel_m2_near_n.Write()
            c_wheel_m2_near_n.SaveAs(path+"run"+run+"_c_wheel_m2_near_noise.gif")
            
        if(TH1F.Noise_Wm2_Far):
            c_wheel_m2_far_n = TCanvas("c_wheel_m2_far_n", "Wheel -2 far noise",23,91,1247,400)
            c_wheel_m2_far_n.SetHighLightColor(2)
            c_wheel_m2_far_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_m2_far_n.SetFillColor(0)
            c_wheel_m2_far_n.SetBorderMode(0)
            c_wheel_m2_far_n.SetBorderSize(2)
            c_wheel_m2_far_n.SetLeftMargin(0.084172)
            c_wheel_m2_far_n.SetRightMargin(0.05489479)
            c_wheel_m2_far_n.SetBottomMargin(0.3698297)
            c_wheel_m2_far_n.SetFrameBorderMode(0)
            c_wheel_m2_far_n.SetFrameBorderMode(0)
            c_wheel_m2_far_n.SetLogy(1)

            TH1F.Noise_Wm2_Far.SetMaximum(100)
            TH1F.Noise_Wm2_Far.SetMinimum(0.001)
            TH1F.Noise_Wm2_Far.SetMarkerColor(1)
            TH1F.Noise_Wm2_Far.SetMarkerStyle(22)
            TH1F.Noise_Wm2_Far.GetXaxis().SetLabelFont(32)
            TH1F.Noise_Wm2_Far.GetXaxis().SetTitleFont(32)
            TH1F.Noise_Wm2_Far.GetYaxis().SetTitle("%")
            TH1F.Noise_Wm2_Far.GetYaxis().SetLabelFont(32)
            TH1F.Noise_Wm2_Far.GetYaxis().SetTitleFont(32)

            TH1F.Noise_Wm2_Far.Draw()


            c_wheel_m2_far_n.Update()
            c_wheel_m2_far_n.Write()
            c_wheel_m2_far_n.SaveAs(path+"run"+run+"_c_wheel_m2_far_noise.gif")        
            

##-------------------------- W-1 Noise -------------------------------------------------
##_near_
        if(TH1F.Noise_Wm1_Near):
            c_wheel_m1_near_n = TCanvas("c_wheel_m1_near_n", "Wheel -1 near noise",23,91,1247,400)
            c_wheel_m1_near_n.SetHighLightColor(2)
            c_wheel_m1_near_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_m1_near_n.SetFillColor(0)
            c_wheel_m1_near_n.SetBorderMode(0)
            c_wheel_m1_near_n.SetBorderSize(2)
            c_wheel_m1_near_n.SetLeftMargin(0.084172)
            c_wheel_m1_near_n.SetRightMargin(0.05489479)
            c_wheel_m1_near_n.SetBottomMargin(0.3698297)
            c_wheel_m1_near_n.SetFrameBorderMode(0)
            c_wheel_m1_near_n.SetFrameBorderMode(0)
            c_wheel_m1_near_n.SetLogy(1)        
            
            TH1F.Noise_Wm1_Near.SetMaximum(100)
            TH1F.Noise_Wm1_Near.SetMinimum(0.001)
            TH1F.Noise_Wm1_Near.SetMarkerColor(1)
            TH1F.Noise_Wm1_Near.SetMarkerStyle(22)
            TH1F.Noise_Wm1_Near.GetXaxis().SetLabelFont(32)
            TH1F.Noise_Wm1_Near.GetXaxis().SetTitleFont(32)
            TH1F.Noise_Wm1_Near.GetYaxis().SetTitle("%")
            TH1F.Noise_Wm1_Near.GetYaxis().SetLabelFont(32)
            TH1F.Noise_Wm1_Near.GetYaxis().SetTitleFont(32)
            
            TH1F.Noise_Wm1_Near.Draw()


            c_wheel_m1_near_n.Update()
            c_wheel_m1_near_n.Write()
            c_wheel_m1_near_n.SaveAs(path+"run"+run+"_c_wheel_m1_near_noise.gif")        
        if(TH1F.Noise_Wm1_Far):            
            c_wheel_m1_far_n = TCanvas("c_wheel_m1_far_n", "Wheel -1 far noise",23,91,1247,400)
            c_wheel_m1_far_n.SetHighLightColor(2)
            c_wheel_m1_far_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_m1_far_n.SetFillColor(0)
            c_wheel_m1_far_n.SetBorderMode(0)
            c_wheel_m1_far_n.SetBorderSize(2)
            c_wheel_m1_far_n.SetLeftMargin(0.084172)
            c_wheel_m1_far_n.SetRightMargin(0.05489479)
            c_wheel_m1_far_n.SetBottomMargin(0.3698297)
            c_wheel_m1_far_n.SetFrameBorderMode(0)
            c_wheel_m1_far_n.SetFrameBorderMode(0)
            c_wheel_m1_far_n.SetLogy(1)
            
            TH1F.Noise_Wm1_Far.SetMaximum(100)
            TH1F.Noise_Wm1_Far.SetMinimum(0.001)
            TH1F.Noise_Wm1_Far.SetMarkerColor(1)
            TH1F.Noise_Wm1_Far.SetMarkerStyle(22)
            TH1F.Noise_Wm1_Far.GetXaxis().SetLabelFont(32)
            TH1F.Noise_Wm1_Far.GetXaxis().SetTitleFont(32)
            TH1F.Noise_Wm1_Far.GetYaxis().SetTitle("%")
            TH1F.Noise_Wm1_Far.GetYaxis().SetLabelFont(32)
            TH1F.Noise_Wm1_Far.GetYaxis().SetTitleFont(32)
            
            TH1F.Noise_Wm1_Far.Draw()
            
            
            c_wheel_m1_far_n.Update()
            c_wheel_m1_far_n.Write()
            c_wheel_m1_far_n.SaveAs(path+"run"+run+"_c_wheel_m1_far_noise.gif")        
            
##-------------------------- W0 Noise -------------------------------------------------
##_near_

        if(TH1F.Noise_W0_Near):            
            c_wheel_0_near_n = TCanvas("c_wheel_0_near_n", "Wheel 0 near noise",23,91,1247,400)
            c_wheel_0_near_n.SetHighLightColor(2)
            c_wheel_0_near_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_0_near_n.SetFillColor(0)
            c_wheel_0_near_n.SetBorderMode(0)
            c_wheel_0_near_n.SetBorderSize(2)
            c_wheel_0_near_n.SetLeftMargin(0.084172)
            c_wheel_0_near_n.SetRightMargin(0.05489479)
            c_wheel_0_near_n.SetBottomMargin(0.3698297)
            c_wheel_0_near_n.SetFrameBorderMode(0)
            c_wheel_0_near_n.SetFrameBorderMode(0)
            c_wheel_0_near_n.SetLogy(1)        
            
            TH1F.Noise_W0_Near.SetMaximum(100)
            TH1F.Noise_W0_Near.SetMinimum(0.001)
            TH1F.Noise_W0_Near.SetMarkerColor(1)
            TH1F.Noise_W0_Near.SetMarkerStyle(22)
            TH1F.Noise_W0_Near.GetXaxis().SetLabelFont(32)
            TH1F.Noise_W0_Near.GetXaxis().SetTitleFont(32)
            TH1F.Noise_W0_Near.GetYaxis().SetTitle("%")
            TH1F.Noise_W0_Near.GetYaxis().SetLabelFont(32)
            TH1F.Noise_W0_Near.GetYaxis().SetTitleFont(32)
            
            TH1F.Noise_W0_Near.Draw()
            
            
            c_wheel_0_near_n.Update()
            c_wheel_0_near_n.Write()
            c_wheel_0_near_n.SaveAs(path+"run"+run+"_c_wheel_0_near_noise.gif")        

        if(TH1F.Noise_W0_Far):            
            c_wheel_0_far_n = TCanvas("c_wheel_0_far_n", "Wheel 0 far noise",23,91,1247,400)
            c_wheel_0_far_n.SetHighLightColor(2)
            c_wheel_0_far_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_0_far_n.SetFillColor(0)
            c_wheel_0_far_n.SetBorderMode(0)
            c_wheel_0_far_n.SetBorderSize(2)
            c_wheel_0_far_n.SetLeftMargin(0.084172)
            c_wheel_0_far_n.SetRightMargin(0.05489479)
            c_wheel_0_far_n.SetBottomMargin(0.3698297)
            c_wheel_0_far_n.SetFrameBorderMode(0)
            c_wheel_0_far_n.SetFrameBorderMode(0)
            c_wheel_0_far_n.SetLogy(1)
            
            TH1F.Noise_W0_Far.SetMaximum(100)
            TH1F.Noise_W0_Far.SetMinimum(0.001)
            TH1F.Noise_W0_Far.SetMarkerColor(1)
            TH1F.Noise_W0_Far.SetMarkerStyle(22)
            TH1F.Noise_W0_Far.GetXaxis().SetLabelFont(32)
            TH1F.Noise_W0_Far.GetXaxis().SetTitleFont(32)
            TH1F.Noise_W0_Far.GetYaxis().SetTitle("%")
            TH1F.Noise_W0_Far.GetYaxis().SetLabelFont(32)
            TH1F.Noise_W0_Far.GetYaxis().SetTitleFont(32)

            TH1F.Noise_W0_Far.Draw()


            c_wheel_0_far_n.Update()
            c_wheel_0_far_n.Write()
            c_wheel_0_far_n.SaveAs(path+"run"+run+"_c_wheel_0_far_noise.gif")


##-------------------------- W1 Noise -------------------------------------------------
##_near_

        if(TH1F.Noise_W1_Near):            
            c_wheel_1_near_n = TCanvas("c_wheel_1_near_n", "Wheel 1 near noise",23,91,1247,400)
            c_wheel_1_near_n.SetHighLightColor(2)
            c_wheel_1_near_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_1_near_n.SetFillColor(0)
            c_wheel_1_near_n.SetBorderMode(0)
            c_wheel_1_near_n.SetBorderSize(2)
            c_wheel_1_near_n.SetLeftMargin(0.084172)
            c_wheel_1_near_n.SetRightMargin(0.05489479)
            c_wheel_1_near_n.SetBottomMargin(0.3698297)
            c_wheel_1_near_n.SetFrameBorderMode(0)
            c_wheel_1_near_n.SetFrameBorderMode(0)
            c_wheel_1_near_n.SetLogy(1)
            
            TH1F.Noise_W1_Near.SetMaximum(100)
            TH1F.Noise_W1_Near.SetMinimum(0.001)
            TH1F.Noise_W1_Near.SetMarkerColor(1)
            TH1F.Noise_W1_Near.SetMarkerStyle(22)
            TH1F.Noise_W1_Near.GetXaxis().SetLabelFont(32)
            TH1F.Noise_W1_Near.GetXaxis().SetTitleFont(32)
            TH1F.Noise_W1_Near.GetYaxis().SetTitle("%")
            TH1F.Noise_W1_Near.GetYaxis().SetLabelFont(32)
            TH1F.Noise_W1_Near.GetYaxis().SetTitleFont(32)
            
            TH1F.Noise_W1_Near.Draw()


            c_wheel_1_near_n.Update()
            c_wheel_1_near_n.Write()
            c_wheel_1_near_n.SaveAs(path+"run"+run+"_c_wheel_1_near_noise.gif")        

        if(TH1F.Noise_W1_Far):            
            c_wheel_1_far_n = TCanvas("c_wheel_1_far_n", "Wheel 1 far noise",23,91,1247,400)
            c_wheel_1_far_n.SetHighLightColor(2)
            c_wheel_1_far_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_1_far_n.SetFillColor(0)
            c_wheel_1_far_n.SetBorderMode(0)
            c_wheel_1_far_n.SetBorderSize(2)
            c_wheel_1_far_n.SetLeftMargin(0.084172)
            c_wheel_1_far_n.SetRightMargin(0.05489479)
            c_wheel_1_far_n.SetBottomMargin(0.3698297)
            c_wheel_1_far_n.SetFrameBorderMode(0)
            c_wheel_1_far_n.SetFrameBorderMode(0)
            c_wheel_1_far_n.SetLogy(1)
            
            TH1F.Noise_W1_Far.SetMaximum(100)
            TH1F.Noise_W1_Far.SetMinimum(-0.1)
            TH1F.Noise_W1_Far.SetMarkerColor(1)
            TH1F.Noise_W1_Far.SetMarkerStyle(22)
            TH1F.Noise_W1_Far.GetXaxis().SetLabelFont(32)
            TH1F.Noise_W1_Far.GetXaxis().SetTitleFont(32)
            TH1F.Noise_W1_Far.GetYaxis().SetTitle("%")
            TH1F.Noise_W1_Far.GetYaxis().SetLabelFont(32)
            TH1F.Noise_W1_Far.GetYaxis().SetTitleFont(32)
            
            TH1F.Noise_W1_Far.Draw()
            
            
            c_wheel_1_far_n.Update()
            c_wheel_1_far_n.Write()
            c_wheel_1_far_n.SaveAs(path+"run"+run+"_c_wheel_1_far_noise.gif")                
...
##-------------------------- W2 Noise -------------------------------------------------
##_near_
        if(TH1F.Noise_W2_Near):            
            c_wheel_2_near_n = TCanvas("c_wheel_2_near_n", "Wheel -2 near noise",23,91,1247,400)
            c_wheel_2_near_n.SetHighLightColor(2)
            c_wheel_2_near_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_2_near_n.SetFillColor(0)
            c_wheel_2_near_n.SetBorderMode(0)
            c_wheel_2_near_n.SetBorderSize(2)
            c_wheel_2_near_n.SetLeftMargin(0.084172)
            c_wheel_2_near_n.SetRightMargin(0.05489479)
            c_wheel_2_near_n.SetBottomMargin(0.3698297)
            c_wheel_2_near_n.SetFrameBorderMode(0)
            c_wheel_2_near_n.SetFrameBorderMode(0)
            c_wheel_2_near_n.SetLogy(1)
            
            TH1F.Noise_W2_Near.SetMaximum(100)
            TH1F.Noise_W2_Near.SetMinimum(0.001)
            TH1F.Noise_W2_Near.SetMarkerColor(1)
            TH1F.Noise_W2_Near.SetMarkerStyle(22)
            TH1F.Noise_W2_Near.GetXaxis().SetLabelFont(32)
            TH1F.Noise_W2_Near.GetXaxis().SetTitleFont(32)
            TH1F.Noise_W2_Near.GetYaxis().SetTitle("%")
            TH1F.Noise_W2_Near.GetYaxis().SetLabelFont(32)
            TH1F.Noise_W2_Near.GetYaxis().SetTitleFont(32)
            
            TH1F.Noise_W2_Near.Draw()
            
            
            c_wheel_2_near_n.Update()
            c_wheel_2_near_n.Write()
            c_wheel_2_near_n.SaveAs(path+"run"+run+"_c_wheel_2_near_noise.gif")
            
        if(TH1F.Noise_W2_Far):
            c_wheel_2_far_n = TCanvas("c_wheel_2_far_n", "Wheel -2 far noise",23,91,1247,400)
            c_wheel_2_far_n.SetHighLightColor(2)
            c_wheel_2_far_n.Range(-10.26568,-73.24462,111.695,124.805)
            c_wheel_2_far_n.SetFillColor(0)
            c_wheel_2_far_n.SetBorderMode(0)
            c_wheel_2_far_n.SetBorderSize(2)
            c_wheel_2_far_n.SetLeftMargin(0.084172)
            c_wheel_2_far_n.SetRightMargin(0.05489479)
            c_wheel_2_far_n.SetBottomMargin(0.3698297)
            c_wheel_2_far_n.SetFrameBorderMode(0)
            c_wheel_2_far_n.SetFrameBorderMode(0)
            c_wheel_2_far_n.SetLogy(1)
            
            TH1F.Noise_W2_Far.SetMaximum(100)
            TH1F.Noise_W2_Far.SetMinimum(0.001)
            TH1F.Noise_W2_Far.SetMarkerColor(1)
            TH1F.Noise_W2_Far.SetMarkerStyle(22)
            TH1F.Noise_W2_Far.GetXaxis().SetLabelFont(32)
            TH1F.Noise_W2_Far.GetXaxis().SetTitleFont(32)
            TH1F.Noise_W2_Far.GetYaxis().SetTitle("%")
            TH1F.Noise_W2_Far.GetYaxis().SetLabelFont(32)
            TH1F.Noise_W2_Far.GetYaxis().SetTitleFont(32)
            
            TH1F.Noise_W2_Far.Draw()


            c_wheel_2_far_n.Update()
            c_wheel_2_far_n.Write()
            c_wheel_2_far_n.SaveAs(path+"run"+run+"_c_wheel_2_far_noise.gif")        
