...
##------------------------------------------- Barrel Noise Global Distribution Function ---------------------------------------------------------------

    def histoWm2NearNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_m2_near_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_m2_near_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_m2_near_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_m2_near_noise.gif ' + self.tmppath)
        self.onPicture(file1)

    def histoWm2FarNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_m2_far_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_m2_far_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_m2_far_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_m2_far_noise.gif ' + self.tmppath)
        self.onPicture(file1)

    def histoWm1NearNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_m1_near_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_m1_near_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_m1_near_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_m1_near_noise.gif ' + self.tmppath)
        self.onPicture(file1)

    def histoWm1FarNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_m1_far_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_m1_far_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_m1_far_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_m1_far_noise.gif ' + self.tmppath)
        self.onPicture(file1)

    def histoW0NearNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_0_near_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_0_near_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_0_near_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_0_near_noise.gif ' + self.tmppath)
        self.onPicture(file1)

    def histoW0FarNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_0_far_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_0_far_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_0_far_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_0_far_noise.gif ' + self.tmppath)
        self.onPicture(file1)

    def histoWp1NearNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_1_near_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_1_near_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_1_near_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_1_near_noise.gif ' + self.tmppath)
        self.onPicture(file1)

    def histoWp1FarNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_1_far_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_1_far_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_1_far_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_1_far_noise.gif ' + self.tmppath)
        self.onPicture(file1)

    def histoWp2NearNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_2_near_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_2_near_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_2_near_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_2_near_noise.gif ' + self.tmppath)
        self.onPicture(file1)

    def histoWp2FarNoise(self):
        file1 = self.tmppath+'run'+self.run+'_c_wheel_2_far_noise.gif'
        if not os.path.exists(self.tmppath+'run'+self.run+'_c_wheel_2_far_noise.gif'):
            os.system("cmsStageIn /store/caf/user/ccmuon/RPC/GlobalRuns/"+self.ds+"/"+self.run+"/gif/run"+self.run+"_c_wheel_2_far_noise.gif "+file1)
            os.system('mv '+ 'run'+self.run+'_c_wheel_2_far_noise.gif ' + self.tmppath)
        self.onPicture(file1)
...
##--------------------------------------------------- Effi Profile Function  -----------------------------------------------------------------------------
    ...
    def histoWp1Eff(self):
        ...
        if not os.path.exists(self.tmppath+'run'+self.run+'_hWp1_eff.gif'):
            ...
            os.system('mv '+ 'run'+self.run+'_hWp1_eff.gif ' + self.tmppath)
        self.onPicture(file1)
...
#-------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def Wm2Menu(self):
        ...
        menu.add_command(label='Nearside Noise', command=self.histoWm2NearNoise) ##
        menu.add_command(label='Farside Noise', command=self.histoWm2FarNoise) ##        
    ...
    def Wm1Menu(self):
        ...
        menu.add_command(label='Nearside Noise', command=self.histoWm1NearNoise) ##
        menu.add_command(label='Farside Noise', command=self.histoWm1FarNoise) ##        
    ...
    def W0Menu(self):
        ...
        menu.add_command(label='Nearside Noise', command=self.histoW0NearNoise) ##
        menu.add_command(label='Farside Noise', command=self.histoW0FarNoise) ##        
    ...
    def Wp1Menu(self):
        ...
        menu.add_command(label='Nearside Noise', command=self.histoWp1NearNoise) ##
        menu.add_command(label='Farside Noise', command=self.histoWp1FarNoise) ##        
    ...
    def Wp2Menu(self):
        ...
        menu.add_command(label='Nearside Noise', command=self.histoWp2NearNoise) ##
        menu.add_command(label='Farside Noise', command=self.histoWp2FarNoise) ##        
