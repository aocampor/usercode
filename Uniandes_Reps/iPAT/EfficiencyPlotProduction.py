...
#from Tkinter import *
from ROOT import TH1F,gROOT,TFile,gDirectory
from math import *
        ...
        for ch in detlist:
            ...
            for roll in rolls_in_chamber:
                ...
                try:
                    ...
                    histoEff = gDirectory.FindObjectAny("Profile_"+roll)
                    ...
                    for j in range(histo1[0].GetNbinsX()):
                        ...
                        if exp_value != 0:
                            ...
                            if not histoEff:
                                ...
                                histoEff1.SetBinContent(j+1,100*histoEff.GetBinContent(j+1))
                                histoEff1.SetBinError(j+1,100*histoEff.GetBinError(j+1))
                    ...
                    self.NewRootFile.cd()
#                    if not histoEff: histoEff1.Write()
 #                   else: histoEff.Write()
                    histoEff1.Write()  
                    histoEff2.Write()
