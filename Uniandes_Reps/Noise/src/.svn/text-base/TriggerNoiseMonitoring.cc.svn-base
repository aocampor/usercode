...
void TriggerNoiseMonitoring::bookTree(){
  ...
  htree->Branch("nrpcdigiroll", &nrpcdigiroll, "nrpcdigiroll/I");
...
TriggerNoiseMonitoring::TriggerNoiseMonitoring(const edm::ParameterSet& iConfig)
{
  ...
  rpcdigi = iConfig.getUntrackedParameter<string>("rpcdigi","muonRPCDigis");
...
*/
  ...
  iEvent.getByLabel(rpcdigi,rpcdigis);
