...
int main(int argc, char *argv[]){
  ...
  ////////
  TH1F *h1 = (TH1F*)f1->FindObjectAny("pfElEl"); 
  TH1F *h2 = (TH1F*)f1->FindObjectAny("MuMu");
  TH1F *eisop = (TH1F*)f1->FindObjectAny("isopromptel");  
  TH1F *eisof = (TH1F*)f1->FindObjectAny("isofakeel");
  TH1F *eisohf = (TH1F*)f1->FindObjectAny("isohfel");
  TH1F *misop = (TH1F*)f1->FindObjectAny("isopromptmu");  
  TH1F *misof = (TH1F*)f1->FindObjectAny("isofakemu");
  TH1F *misohf = (TH1F*)f1->FindObjectAny("isohfmu");    
  TCanvas *can = new TCanvas("c1","c1",1301,333,620,544);
  gStyle->SetOptStat(0);
  gStyle->SetOptTitle(0);
  gStyle->SetPalette(1);
  can->Range(-0.125,-0.125,1.125,1.125);
  can->SetFillColor(0);
  can->SetBorderSize(0);
  can->SetTickx(1);
  can->SetTicky(1);
  ...
  can->SetFillColor(0);
  eisop->SetFillColor(0);
  eisop->SetMarkerColor(1);
  eisop->GetXaxis()->SetTitle("pf Combined Iso");
  eisop->GetXaxis()->SetLabelFont(42);
  eisop->GetXaxis()->SetTitleFont(42);
  eisop->GetYaxis()->SetTitle("N. Entries");
  eisop->GetYaxis()->SetLabelFont(42);
  eisop->GetYaxis()->SetTitleFont(42);
  eisop->GetYaxis()->SetRangeUser(0,1);
  eisop->DrawNormalized();
  eisof->SetLineColor(2);
  eisof->DrawNormalized("SAME");
  eisohf->SetLineColor(3);
  eisohf->DrawNormalized("SAME");
  can->SaveAs("IsolationTemp_Jpsi_el.gif"); 
  misop->SetFillColor(0);
  misop->SetMarkerColor(1);
  misop->GetXaxis()->SetTitle("pf Combined Iso");
  misop->GetXaxis()->SetLabelFont(42);
  misop->GetYaxis()->SetTitleFont(42);
  misop->GetYaxis()->SetLabelFont(42);
  misop->GetXaxis()->SetTitleFont(42);
  misop->GetYaxis()->SetRangeUser(0,1);
  misop->DrawNormalized();
  misof->SetLineColor(2);
  misof->DrawNormalized("SAME");
  misohf->SetLineColor(3);
  misohf->DrawNormalized("SAME");
  can->SaveAs("IsolationTemp_Jpsi_mu.gif"); 
  h1->SetFillColor(0);
  h1->GetXaxis()->SetRangeUser(2.5,4);
  h1->GetXaxis()->SetTitle("Invariant Mass pf e - e");
  h1->GetXaxis()->SetLabelFont(42);
  h1->GetXaxis()->SetTitleFont(42);
  h1->GetYaxis()->SetTitle("N. Entries/0.05 GeV");
  h1->GetYaxis()->SetLabelFont(42);
  h1->GetYaxis()->SetTitleFont(42);
  h1->Draw();
  can->SaveAs("InvariantMass_pfel.gif"); 
  h2->SetFillColor(0);
  h2->GetXaxis()->SetRangeUser(2.5,4);    
  h2->GetXaxis()->SetTitle("Invariant Mass pf #mu - #mu");
  h2->GetXaxis()->SetLabelFont(42);
  h2->GetXaxis()->SetTitleFont(42);
  h2->GetYaxis()->SetTitle("N. Entries/0.05 GeV");
  h2->GetYaxis()->SetLabelFont(42);
  h2->GetYaxis()->SetTitleFont(42);
  h2->Draw();
  can->SaveAs("InvariantMass_pfmu.gif"); 
...
void IsolOpt::Loop(){
  ...
  for (int i1=0; i1<3; i1++){
	...
	//	}
	double Integ=recpfEl[i1][i2][i3]->Integral(0,recpfEl[i1][i2][i3]->GetNbinsX()+1);   
	...
	double Integm=recpfMu[i1][i2][i3]->Integral(0,recpfMu[i1][i2][i3]->GetNbinsX()+1);   
	...
	//cout << "The histogram " << effMus[i1][i2]->GetName() << " has an efficiency of: " << effm << " and reaches until: " << i4 << " and is being filled by " <<recMus[i1][i2]->GetName() << endl;  
      ...
      //      }
      //      cout << recpfEls[i1][i2]->GetNbinsX()+1 << endl;
      //      cout << recpfEls[i1][i2]->Integral(0,recpfEls[i1][i2]->GetNbinsX()+1) << endl;
      double Integ=recpfEls[i1][i2]->Integral(0,recpfEls[i1][i2]->GetNbinsX()+1);   
      //double Integ =1;
	...
	effpfEls[i1][i2]->SetBinError(i4+1,err);
      ...
      double Integm=recpfMus[i1][i2]->Integral(0,recpfMus[i1][i2]->GetNbinsX()+1);   
	...
	effpfMus[i1][i2]->SetBinError(i4+1,errm);
      ...
      if(i1!=0){
	for (int i4=0; i4<effpfEls[i1][i2]->GetNbinsX(); i4++){
