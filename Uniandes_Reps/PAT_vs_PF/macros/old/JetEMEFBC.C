...
void JetEMEFBC(void){
    ...
    TH1F* f1 = (TH1F*)file1->FindObjectAny("JetEMFBC");

    TFile *file2;
    file2 = TFile::Open("PAT_second.root");
    TH1F* f2 = (TH1F*)file2->FindObjectAny("JetEMFBC");

    TFile *file3;
    file3 = TFile::Open("PF_IC5_Jets_Corrected.root");
    TH1F* f3 = (TH1F*)file3->FindObjectAny("JetEMFBC");

    TFile *file4;
    file4 = TFile::Open("PF_ak5_tot.root");
    TH1F* f4 = (TH1F*)file4->FindObjectAny("JetEMFBC");
    ...
    pt3->Draw("SAME");
    ptstats3->Draw("SAME");
    c1->SaveAs("JetEMEFBeforeCutsComparisonAllIhaverightnow.gif");
