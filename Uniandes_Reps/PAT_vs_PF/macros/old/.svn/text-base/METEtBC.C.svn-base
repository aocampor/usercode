...
void METEtBC(void){
    ...
    TH1F* f1 = (TH1F*)file1->FindObjectAny("METEtBC");

    TFile *file2;
    file2 = TFile::Open("PAT_second.root");
    TH1F* f2 = (TH1F*)file2->FindObjectAny("METEtBC");

    TFile *file3;
    file3 = TFile::Open("PF_IC5_Jets_Corrected.root");
    TH1F* f3 = (TH1F*)file3->FindObjectAny("METEtBC");

    TFile *file4;
    file4 = TFile::Open("PF_ak5_tot.root");
    TH1F* f4 = (TH1F*)file4->FindObjectAny("METEtBC");
    ...
    text = pt->AddText("PF Jets Pt > 10 GeV MET Before Cuts");
    ...
    pt1->SetFillColor(0);
    pt1->SetTextColor(2);
    text1 = pt1->AddText("PAT MET Before Cuts");
    ...
    pt2->SetFillColor(0);
    pt2->SetTextColor(3);
    text2 = pt2->AddText("PF IC5 Pt > 0 GeV Jets, MET Before Cuts");
    ...
    pt3->SetFillColor(0);
    pt3->SetTextColor(4);
    text3 = pt3->AddText("PF ak5 MET Before Cuts");
    ...
    pt3->Draw("SAME");
    ptstats3->Draw("SAME");
    c1->SaveAs("METEtBeforeCutsComparisonAllIhaverightnow.gif");
