...
//=========  (Tue Dec 15 15:43:39 2009) by ROOT version5.25/02
   ...
   TH1F *optEffEl_tot_ = new TH1F("optEffEl_tot_","particle flow electron",10,0,30);
   ...
   TPaveStats *ptstats = new TPaveStats(0.5948276,0.6186441,0.8577586,0.8580508,"brNDC");
   ...
   TPaveText *pt = new TPaveText(0.2600575,0.9152542,0.5948276,0.9639831,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetTextFont(42);
   text = pt->AddText("particle flow electron");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
