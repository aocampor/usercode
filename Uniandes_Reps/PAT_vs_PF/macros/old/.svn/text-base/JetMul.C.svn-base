...
void JetMul(void){
    ...
    TH1F* f1 = (TH1F*)file1->FindObjectAny("NumberOfJetsBC");

    TFile *file2;
    file2 = TFile::Open("PAT_second.root");
    TH1F* f2 = (TH1F*)file2->FindObjectAny("NumberOfJetsBC");

    TFile *file3;
    file3 = TFile::Open("PF_IC5_Jets_Corrected.root");
    TH1F* f3 = (TH1F*)file3->FindObjectAny("NumberOfJetsBC");

    TFile *file4;
    file4 = TFile::Open("PF_ak5_tot.root");
    TH1F* f4 = (TH1F*)file4->FindObjectAny("NumberOfJetsBC");
    ...
    f1->SetStats(kFALSE);
    f1->GetXaxis()->SetTitle("Number of Jets");
    f1->GetXaxis()->SetLabelFont(42);
    f1->GetXaxis()->SetTitleFont(42);
    f1->GetYaxis()->SetTitle("Events");
    f1->GetYaxis()->SetLabelFont(42);
    f1->GetYaxis()->SetTitleOffset(1.19);
    ...
    TPaveStats *ptstats = new TPaveStats(0.7114943,0.7488136,0.8726437,0.8877119,"brNDC");
    ...
    TPaveStats *ptstats1 = new TPaveStats(0.7114943,0.5988136,0.8726437,0.7377119,"brNDC");
    ...
    TPaveStats *ptstats2 = new TPaveStats(0.7114943,0.4488136,0.8726437,0.5877119,"brNDC");
    ...
    TPaveStats *ptstats3 = new TPaveStats(0.7114943,0.2988136,0.8726437,0.4377119,"brNDC");
    ...
    text = pt->AddText("PF IC5 Pt > 10 GeV Number of Jets before cuts");
    ...
    pt1->SetFillColor(0);
    pt1->SetTextColor(2);
    text1 = pt1->AddText("PAT Number of Jets before cuts");
    ...
    pt2->SetFillColor(0);
    pt2->SetTextColor(3);
    text2 = pt2->AddText("PF IC5 Pt > 0 GeV Number of Jets before cuts");

    TPaveText *pt3 = new TPaveText(0.3066092,0.5861864,0.7055747,0.63055085,"blNDC");
    pt3->SetName("title");
    pt3->SetBorderSize(0);
    pt3->SetTextFont(42);
    pt3->SetFillColor(0);
    pt3->SetTextColor(4);
    text3 = pt3->AddText("PF ak5 Number of Jets before cuts");
    ...
    pt3->Draw("SAME");
    ptstats3->Draw("SAME");
    c1->SaveAs("NumberOfJetsBeforeCutsComparisonAllIhaverightnow.gif");
