...
void JetEMFSevBC(void){
    std::cout << "Hellowww!!" << std::endl;
    
    TFile *file1;
    file1 = TFile::Open("PF_second.root");
    //    TH1F* f1 = (TH1F*)file1->FindObjectAny("Jet_1_EMFJet_1_EMF_wc");
    // TH1F* f1_2 = (TH1F*)file1->FindObjectAny("Jet_2_EMFJet_2_EMF_wc");
    //TH1F* f1_3 = (TH1F*)file1->FindObjectAny("Jet_3_EMFJet_3_EMF_wc");

    TFile *file2;
    file2 = TFile::Open("PAT_second.root");
    //TH1F* f2 = (TH1F*)file2->FindObjectAny("Jet_1_EMFJet_1_EMF_wc");
    //TH1F* f2_2 = (TH1F*)file2->FindObjectAny("Jet_2_EMFJet_2_EMF_wc");
    //TH1F* f2_3 = (TH1F*)file2->FindObjectAny("Jet_3_EMFJet_3_EMF_wc");

    TFile *file3;
    file3 = TFile::Open("PF_IC5_Jets_Corrected.root");
    TH1F* f3 = (TH1F*)file3->FindObjectAny("Jet_1_PtJet_1_Pt_wc");
    TH1F* f3_2 = (TH1F*)file3->FindObjectAny("Jet_2_PtJet_2_Pt_wc");
    TH1F* f3_3 = (TH1F*)file3->FindObjectAny("Jet_3_PtJet_3_Pt_wc");

    TFile *file4;
    file4 = TFile::Open("PF_ak5_tot.root");
    TH1F* f4 = (TH1F*)file4->FindObjectAny("Jet_1_PtJet_1_Pt_wc");
    TH1F* f4_2 = (TH1F*)file4->FindObjectAny("Jet_2_PtJet_2_Pt_wc");
    TH1F* f4_3 = (TH1F*)file4->FindObjectAny("Jet_3_PtJet_3_Pt_wc");
    ...
    //f1->SetStats(kFALSE);
    f4->GetXaxis()->SetTitle("EM Energy Fraction");
    ...
    //f1_2->SetStats(kFALSE);
    //f1_2->SetLineColor(1);
    //f1_2->SetLineWidth(1);

    //f1_3->SetStats(kFALSE);
    //f1_3->SetLineColor(1);
    //f1_3->SetLineWidth(1);
    ...
    //f2_2->SetStats(kFALSE);
    //f2_2->SetLineColor(2);
    //f2_2->SetLineWidth(3);

    //f2_3->SetStats(kFALSE);
    //f2_3->SetLineColor(2);
    //f2_3->SetLineWidth(3);
    ...
    f3_2->SetStats(kFALSE);
    f3_2->SetLineColor(3);
    f3_2->SetLineWidth(2);

    f3_3->SetStats(kFALSE);
    f3_3->SetLineColor(3);
    f3_3->SetLineWidth(2);
    ...
    f4_2->SetStats(kFALSE);
    f4_2->SetLineColor(4);
    f4_2->SetLineWidth(4);

    f4_3->SetStats(kFALSE);
    f4_3->SetLineColor(4);
    f4_3->SetLineWidth(4);
    ...
    text = pt->AddText("PF Jets Pt > 10 GeV EM Energy Fraction Before Cuts");
    ...
    pt1->SetFillColor(0);
    pt1->SetTextColor(2);
    text1 = pt1->AddText("PAT Jets EM Energy Fraction Before Cuts");
    ...
    pt2->SetFillColor(0);
    pt2->SetTextColor(3);
    text2 = pt2->AddText("PF IC5 Pt > 0 GeV Jets EM Energy Fraction Before Cuts");
    ...
    pt3->SetFillColor(0);
    pt3->SetTextColor(4);
    text3 = pt3->AddText("PF ak5 EM Energy Fraction Before Cuts");
    ...
    pt3->Draw("SAME");
    ptstats3->Draw("SAME");
    c1->SaveAs("JetEMFSeveralJetsBeforeCutsComparisonAllIhaverightnow.gif");
