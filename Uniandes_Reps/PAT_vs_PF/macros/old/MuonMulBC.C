...
void MuonMulBC(void){
    ...
    TH1F* f1 = (TH1F*)file1->FindObjectAny("NumberOfMuonsBC");

    TFile *file2;
    file2 = TFile::Open("PAT_second.root");
    TH1F* f2 = (TH1F*)file2->FindObjectAny("NumberOfMuonsBC");

    TFile *file3;
    file3 = TFile::Open("PF_IC5_Jets_Corrected.root");
    TH1F* f3 = (TH1F*)file3->FindObjectAny("NumberOfMuonsBC");

    TFile *file4;
    file4 = TFile::Open("PF_ak5_tot.root");
    TH1F* f4 = (TH1F*)file4->FindObjectAny("NumberOfMuonsBC");
    ...
    f1->SetStats(kFALSE);
    f1->GetXaxis()->SetTitle("Number of Muons");
    ...
    text = pt->AddText("PF Isolation < 0.14 GeV Number of Muons before cuts");
    ...
    pt1->SetFillColor(0);
    pt1->SetTextColor(2);
    text1 = pt1->AddText("PAT Number of Muons before cuts");
    ...
    pt2->SetFillColor(0);
    pt2->SetTextColor(3);
    text2 = pt2->AddText("PF IC5 Isolation < 500 GeV Number of Muons before cuts");
    ...
    pt3->SetFillColor(0);
    pt3->SetTextColor(4);
    text3 = pt3->AddText("PF ak5 Number of Muons before cuts");
    ...
    pt3->Draw("SAME");
    ptstats3->Draw("SAME");
    c1->SaveAs("NumberOfMuonsBeforeCutsComparisonAllIhaverightnow.gif");
